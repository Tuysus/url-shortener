...
$.getJSON2 = function(url, data, callback, errorCallback, timeout) {
    if (!timeout)
        timeout = 20000;
...
$.postJSON = function(url, webModel, callback, errorCallback, timeout) {
    if (!timeout)
        timeout = 20000;
...
$.deleteJSON = function(url, data, callback, errorCallback, timeout) {
    if (!timeout)
        timeout = 20000;
...
$.deleteJSON2 = function(url, data, callback, errorCallback, timeout) {
    if (!timeout)
        timeout = 20000;
...
function serializeObject(formSelector) {
    var obj = {};
    $.each($(formSelector).serializeArray(), function(i, o) {
